...
function App(): JSX.Element {
  return (
    ...
    />
      ...
      place={"Sardinia"}
      country = {"Italy"}
      main = {"https://images.unsplash.com/photo-1534248889024-3983df68b49d?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1134&q=80"}
      
      link={"https://www.google.com/maps/place/Spiaggia+di+San+Giovanni/@40.4330656,7.7327869,9z/data=!4m5!3m4!1s0x12dcf1fed5caaaed:0xd2ba3f2228f1dec0!8m2!3d40.575973!4d8.3141181"}
      description={"Quite place with amazing view"}
      />
      {/* <Place
      ...
      link={"https://www.google.com/maps/place/Bermondsey+St,+London,+UK/@51.4990427,-0.0923738,14z/data=!4m5!3m4!1s0x48760344c9823bdf:0xda831ed87e8aea2b!8m2!3d51.5007926!4d-0.0818488"}
      description={"Quite place with amazing view"} */}
